...
- **Schedule Git commits on a daily or weekend basis.**
- **Dashboard for managing commits.**
- **Form for creating commits.**
...
In order to run this project you need: any web-browser and node.

### Setup

Clone this [repository](https://github.com/shubhambhoyar077/git-green) to your desired folder.
...
- Clone this [repository](https://github.com/shubhambhoyar077/git-green) in your local machine with correct branch.
- Terminal:- **npm run dev** it will run on port 5173.
